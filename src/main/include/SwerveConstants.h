...
namespace swerve {
    ...
    namespace physical {
        ...
        constexpr units::meter_t kDriveBaseWidth = 23_in * 1.08;
        constexpr units::meter_t kDriveBaseLength = 23_in * 1.08;
        ...
        /*constexpr double kFrontLeftAbsoluteOffset = -0.190;
        constexpr double kFrontRightAbsoluteOffset = 0.314;
        constexpr double kBackLeftAbsoluteOffset = -0.449;
        constexpr double kBackRightAbsoluteOffset = -0.096;*/

        constexpr double kFrontLeftAbsoluteOffset = 0.223;
        constexpr double kFrontRightAbsoluteOffset = -0.326;
        constexpr double kBackLeftAbsoluteOffset = 0.448;
        constexpr double kBackRightAbsoluteOffset = 0.362;
    }
}